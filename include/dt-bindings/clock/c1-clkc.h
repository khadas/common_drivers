...
#define CLKID_FCLK_DIV3_DIV			11
#define CLKID_FCLK_DIV4_DIV			12
#define CLKID_FCLK_DIV5_DIV			13
#define CLKID_FCLK_DIV7_DIV			14
#define CLKID_GP_PLL				15
#define CLKID_HIFI_PLL				16
#define CLKID_SYS_PLL				17
#define CLKID_AUD_DDS				18
#define CLKID_SYS_A_SEL				19
#define CLKID_SYS_A_DIV				20

#define CLKID_SYS_A				    21
#define CLKID_SYS_B_SEL				22
#define CLKID_SYS_B_DIV				23
#define CLKID_SYS_B				    24
#define CLKID_SYS_CLK				25
#define CLKID_AXI_A_SEL				26
#define CLKID_AXI_A_DIV				27
#define CLKID_AXI_A					28
#define CLKID_AXI_B_SEL				29
#define CLKID_AXI_B_DIV				30
#define CLKID_AXI_B					31
#define CLKID_AXI_CLK				32

#define CLKID_GP_PLL_DIV1			33
#define CLKID_GP_PLL_DIV1_FIX_DIV2	34
#define CLKID_GP_PLL_DIV1_GATE		35
#define CLKID_GP_PLL_DIV2_FIX_DIV2	36
#define CLKID_GP_PLL_DIV2			37
#define CLKID_GP_PLL_DIV2_GATE		38
#define CLKID_GP_PLL_DIV3			39
#define CLKID_GP_PLL_DIV3_GATE		40
#define CLKID_CPU_BASE				41
...
#define CLKID_DSU_SOURCE_SEL0			(CLKID_CPU_BASE + 8)
#define CLKID_DSU_SOURCE_DIV0			(CLKID_CPU_BASE + 9)
#define CLKID_DSU_SEL0				(CLKID_CPU_BASE + 10)
#define CLKID_DSU_SOURCE_SEL1			(CLKID_CPU_BASE + 11)
#define CLKID_DSU_SOURCE_DIV1			(CLKID_CPU_BASE + 12)
#define CLKID_DSU_SEL1				(CLKID_CPU_BASE + 13)
#define CLKID_DSU_FIXED				(CLKID_CPU_BASE + 14)
#define CLKID_DSU_PRE				(CLKID_CPU_BASE + 15)
#define CLKID_DSU_CLK				(CLKID_CPU_BASE + 16)

/* CLKTREE_SYS_OSCIN_CTRL gates*/
#define XTAL_BASE				(CLKID_CPU_BASE + 17)
...
#define GATE_BASE0				(XTAL_BASE + 12)
...
#define CLKID_SYS_SD_EMMC_A			(GATE_BASE0 + 26)
...
#define CLKID_RSA				(GATE_BASE1 + 6)
#define CLKID_SYS_CORESIGHT			(GATE_BASE1 + 7)
#define CLKID_CSI_PH1				(GATE_BASE1 + 8)
#define CLKID_CSI_PHY0				(GATE_BASE1 + 9)
#define CLKID_MIPI_ISP				(GATE_BASE1 + 10)
#define CLKID_CSI_DIG				(GATE_BASE1 + 11)
#define CLKID_SYS_G2ED				(GATE_BASE1 + 12)
#define CLKID_SYS_GDC				(GATE_BASE1 + 13)
#define CLKID_DOS_APB				(GATE_BASE1 + 14)
#define CLKID_SYS_NNA				(GATE_BASE1 + 15)
#define CLKID_SYS_ETH_PHY			(GATE_BASE1 + 16)
#define CLKID_SYS_ETH_MAC			(GATE_BASE1 + 17)
#define CLKID_SYS_UART_E			(GATE_BASE1 + 18)
#define CLKID_SYS_UART_D			(GATE_BASE1 + 19)
#define CLKID_SYS_PWM_IJ			(GATE_BASE1 + 20)
#define CLKID_SYS_PWM_GH			(GATE_BASE1 + 21)
#define CLKID_SYS_I2C_M_E			(GATE_BASE1 + 22)
#define CLKID_SYS_SD_EMMC_C			(GATE_BASE1 + 23)
#define CLKID_SYS_SD_EMMC_B			(GATE_BASE1 + 24)
#define CLKID_SYS_ROM				(GATE_BASE1 + 25)
#define CLKID_SYS_SPIFC				(GATE_BASE1 + 26)
#define CLKID_SYS_PROD_I2C			(GATE_BASE1 + 27)
#define CLKID_SYS_DOS				(GATE_BASE1 + 28)
#define CLKID_SYS_CPU_CTRL			(GATE_BASE1 + 29)
#define CLKID_SYS_RAMA				(GATE_BASE1 + 30)
#define CLKID_SYS_RAMB				(GATE_BASE1 + 31)
#define CLKID_SYS_RAMC				(GATE_BASE1 + 32)
/* CLKTREE_AXI_CLK_EN gates */
#define GATE_BASE2				(GATE_BASE1 + 33)
...
#define CLKID_AXI_RAMB				(GATE_BASE2 + 4)
#define CLKID_AXI_RAMA				(GATE_BASE2 + 5)
#define CLKID_AXI_SPIFC				(GATE_BASE2 + 6)
#define CLKID_AXI_NIC				(GATE_BASE2 + 7)
#define CLKID_AXI_DMA				(GATE_BASE2 + 8)
#define CLKID_AXI_RAMC				(GATE_BASE2 + 9)
/* dsp clks */
#define DSP_BASE				(GATE_BASE2 + 10)
...
#define CLKID_SD_EMMC_D_SEL			(BASIC_BASE2 + 19)
#define CLKID_SD_EMMC_D_DIV			(BASIC_BASE2 + 20)
#define CLKID_SD_EMMC_D_GATE			(BASIC_BASE2 + 21)
#define CLKID_SD_EMMC_D				(BASIC_BASE2 + 22)
#define CLKID_FIXED_PLL_DIV2			(BASIC_BASE2 + 23)
#define CLKID_AXI_CLK_FRCPU			(BASIC_BASE2 + 24)

/*mm clk*/

#define CLKID_MM_BASE0				(BASIC_BASE2 + 25)
...
#define CLKID_ETH_BASE				(CLKID_MM_BASE1 + 28)
#define CLKID_ETH_CLK125_SEL			(CLKID_ETH_BASE + 0)
#define CLKID_ETH_CLK125_DIV			(CLKID_ETH_BASE + 1)
#define CLKID_ETH_CLK125_GATE			(CLKID_ETH_BASE + 2)
#define CLKID_ETH_CLK_RMII_SEL			(CLKID_ETH_BASE + 3)
#define CLKID_ETH_CLK_RMII_DIV			(CLKID_ETH_BASE + 4)
#define CLKID_ETH_CLK_RMII_GATE			(CLKID_ETH_BASE + 5)
#define CLKID_END_BASE				(CLKID_ETH_BASE + 6)
#endif /* __A1_CLKC_H */
