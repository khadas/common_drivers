...
static void lcd_mlvds_control_set(struct aml_lcd_drv_s *pdrv)
{
	...
	case LCD_CHIP_TXHD2:
		lcd_combo_dphy_write(pdrv, COMBO_DPHY_CNTL0_TXHD2, 0x55555);
		/* fifo_clk_sel[7:6]: 0=div6, 1=div 7, 2=div8, 3=div10 */
		lcd_combo_dphy_write(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0_TXHD2, (div_sel << 6));
		/* serializer_en[27:16] */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0_TXHD2, 0xfff, 16, 12);
		/* pn swap[2] */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0_TXHD2, 1, 2, 1);

		/* fifo enable[30], phy_clock gating[24] */
		lcd_combo_dphy_write(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL1_TXHD2,
					(1 << 30) | (1 << 24));
		/* fifo write enable[31] */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL1_TXHD2, 1, 31, 1);
...
static void lcd_mlvds_disable(struct aml_lcd_drv_s *pdrv)
{
	...
	case LCD_CHIP_TXHD2:
		/* disable fifo */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL1_TXHD2, 0, 30, 2);
		/* disable lane */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0_TXHD2, 0, 16, 12);
		break;
	default:
		/* disable fifo */
		lcd_ana_setb(HHI_LVDS_TX_PHY_CNTL1, 0, 30, 2);
...
static void lcd_p2p_control_set(struct aml_lcd_drv_s *pdrv)
{
	...
	case LCD_CHIP_T3X:
		...
		/* set fifo_clk_sel: div */
		lcd_combo_dphy_write(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0, (phy_div << 5));
		/* set cntl_ser_en:  all-channel to 1 */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0, 0xffff, 16, 16);
		/* pn swap */
		lcd_combo_dphy_setb(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL0, 1, 2, 1);

		/* decoupling fifo enable, gated clock enable */
		lcd_combo_dphy_write(pdrv, COMBO_DPHY_EDP_LVDS_TX_PHY0_CNTL1, (1 << 6) | (1 << 0));
		/* decoupling fifo write enable after fifo enable */
