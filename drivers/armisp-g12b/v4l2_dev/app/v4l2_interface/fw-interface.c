...
static int isp_fw_do_set_awb_mode_id( uint32_t ctx_id, int val )
{
    ...
    case ISP_V4L2_AWB_MODE_FLUORESCENT:
        awb_mode_id_val = AWB_FLUORESCENT;
        break;
    ...
    case ISP_V4L2_AWB_MODE_WARM_FLUORESCENT:
        awb_mode_id_val = AWB_WARM_FLUORESCENT;
        break;
    default:
...
int fw_intf_set_white_balance_auto( uint32_t ctx_id, int val )
{
    ...
    // return SUCCESS for compatibility verification issue
    return 0;
}
...
int fw_intf_set_white_balance( uint32_t ctx_id, int val )
{
    ...
    case 5000:
        ...
        break;
    case 4000:
        mode = AWB_FLUORESCENT;
        break;
    case 3000:
        mode = AWB_WARM_FLUORESCENT;
        break;
    case 2000:
    ...
    char *buf)
{
    ...
    else if ( ret_val == AWB_FLUORESCENT ) ret += sprintf(&buf[i],"AWB_MODE_ID : AWB_FLUORESCENT\n");
    ...
    else if ( ret_val == AWB_WARM_FLUORESCENT ) ret += sprintf(&buf[i],"AWB_MODE_ID : AWB_WARM_FLUORESCENT\n");
    MOVE_I_TO_NEXT;
