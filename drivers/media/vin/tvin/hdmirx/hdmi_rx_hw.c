 ...
 */
u32 hdmirx_audio_fifo_rst(void)
{
	int error = 0;
...
bool rx_need_support_fastswitch(void)
{
	...
	if (rx_info.boot_flag && rx_info.main_port == E_PORT0) {
		if (hdmirx_rd_cor(SCDCS_TMDS_CONFIG_SCDC_IVCRX, rx_info.main_port) & 2)
			ret = true;
