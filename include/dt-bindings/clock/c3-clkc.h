...
#define CLKID_MIXED_BASE                        (CLKID_GP_PLL_BASE + 4)
...
#define CLKID_SYS_CLKTREE			(GATE_BASE0 + 0)
#define CLKID_SYS_RESET_CTRL			(GATE_BASE0 + 1)
#define CLKID_SYS_ANALOG_CTRL			(GATE_BASE0 + 2)
#define CLKID_SYS_PWR_CTRL			(GATE_BASE0 + 3)
#define CLKID_SYS_PAD_CTRL			(GATE_BASE0 + 4)
#define CLKID_SYS_CTRL				(GATE_BASE0 + 5)
#define CLKID_SYS_TS_PLL			(GATE_BASE0 + 6)
#define CLKID_SYS_DEV_ARB			(GATE_BASE0 + 7)
#define CLKID_SYS_MMC_PCLK			(GATE_BASE0 + 8)
#define CLKID_SYS_CAPU				(GATE_BASE0 + 9)
#define CLKID_SYS_CPU_CTRL			(GATE_BASE0 + 10)
#define CLKID_SYS_JTAG_CTRL			(GATE_BASE0 + 11)
#define CLKID_SYS_IR_CTRL			(GATE_BASE0 + 12)
#define CLKID_SYS_IRQ_CTRL			(GATE_BASE0 + 13)
#define CLKID_SYS_MSR_CLK			(GATE_BASE0 + 14)
#define CLKID_SYS_ROM				(GATE_BASE0 + 15)
#define CLKID_SYS_AOCPU				(GATE_BASE0 + 16)
#define CLKID_SYS_CPU_ARB			(GATE_BASE0 + 17)
#define CLKID_SYS_RSA				(GATE_BASE0 + 18)
#define CLKID_SYS_SAR_ADC			(GATE_BASE0 + 19)
#define CLKID_SYS_STARTUP			(GATE_BASE0 + 20)
#define CLKID_SYS_SECURE			(GATE_BASE0 + 21)
#define CLKID_SYS_SPIFC				(GATE_BASE0 + 22)
#define CLKID_SYS_NNA				(GATE_BASE0 + 23)
#define CLKID_SYS_ETH_MAC			(GATE_BASE0 + 24)
#define CLKID_SYS_GIC				(GATE_BASE0 + 25)
#define CLKID_SYS_RAMA				(GATE_BASE0 + 26)
#define CLKID_SYS_BIG_NIC			(GATE_BASE0 + 27)
#define CLKID_SYS_RAMB				(GATE_BASE0 + 28)
#define CLKID_SYS_AUDIO_PCLK			(GATE_BASE0 + 29)
/* CLKTREE_SYS_CLK_EN1 gates*/
#define GATE_BASE1				(GATE_BASE0 + 30)
#define CLKID_SYS_AUDIO_TOP			(GATE_BASE1 + 0)
#define CLKID_SYS_AUDIO_VAD			(GATE_BASE1 + 1)
...
#define CLKID_AXI_CPU_DMC			(GATE_BASE2 + 4)
#define CLKID_AXI_MUX_NIC			(GATE_BASE2 + 5)
#define CLKID_AXI_CVE				(GATE_BASE2 + 6)
#define CLKID_AXI_DEV1_DMC			(GATE_BASE2 + 7)
/* dsp clks */
...
#define CLKID_SPICC_A				(BASIC_BASE + 43)
#define CLKID_MMC_PCLK_SEL			(BASIC_BASE + 45)
#define CLKID_MMC_PCLK_DIV			(BASIC_BASE + 46)
#define CLKID_MMC_PCLK_GATE			(BASIC_BASE + 47)
#define CLKID_MMC_PCLK_MUX			(BASIC_BASE + 48)
#define CLKID_TS_DIV				(BASIC_BASE + 49)
#define CLKID_TS				(BASIC_BASE + 50)
#define CLKID_ETH_RMII_DIV			(BASIC_BASE + 51)
#define CLKID_ETH_RMII				(BASIC_BASE + 52)
#define CLKID_ETH_125M_DIV			(BASIC_BASE + 53)
#define CLKID_ETH_125M				(BASIC_BASE + 54)
#define CLKID_SPICC_B_SEL			(BASIC_BASE + 55)
#define CLKID_SPICC_B_DIV			(BASIC_BASE + 56)
#define CLKID_SPICC_B				(BASIC_BASE + 57)
#define BASIC_BASE2				(BASIC_BASE + 58)
