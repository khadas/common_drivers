...
#include <dt-bindings/clock/g12a-audio-clk.h>
...
CLOCK_GATE(audio_loopback, AUD_ADDR_OFFSET(EE_AUDIO_CLK_GATE_EN0), 15, clk81);
...
CLOCK_GATE(audio_resample, AUD_ADDR_OFFSET(EE_AUDIO_CLK_GATE_EN0), 18, clk81);
CLOCK_GATE
	(audio_power_detect,
...
/* spdifout b*/
CLOCK_COM_MUX(spdifout_b, AUD_ADDR_OFFSET(EE_AUDIO_CLK_SPDIFOUT_B_CTRL), 0x7, 24);
