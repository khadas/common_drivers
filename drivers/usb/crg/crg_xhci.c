...
static int (*aml_prepare_transfer) (struct xhci_hcd *xhci,
...
unsigned char crg_control_flag;
		...
		struct urb *urb, int slot_id, unsigned int ep_index)
{
	...
	ret = aml_prepare_transfer(xhci, xhci->devs[slot_id],
...
int crg_xhci_init(void)
{
	...
	aml_prepare_transfer = get_symbol_addr("prepare_transfer");
	...
	if (!aml_prepare_transfer || !aml_queue_trb || !aml_xhci_ring_ep_doorbell ||
