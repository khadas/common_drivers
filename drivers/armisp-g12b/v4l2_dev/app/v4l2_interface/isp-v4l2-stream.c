...
void isp_v4l2_stream_off(isp_v4l2_stream_t *pstream, int stream_on_count)
{
    ...
    LOG(LOG_CRIT, "[Stream#%d] called", pstream->stream_id);
...
#if ISP_HAS_META_CB
    if ((pstream->stream_id == V4L2_STREAM_TYPE_META) && (f->fmt.pix_mp.pixelformat != ISP_V4L2_PIX_FMT_META))
    {
...
static int isp_v4l2_get_crop_type(isp_v4l2_stream_t *pstream)
{
    ...
    case V4L2_STREAM_TYPE_DS1:
        ...
        break;
    default:
        LOG(LOG_ERR, "Error: this stream cannot support crop");
        break;
    }
