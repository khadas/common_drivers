...
static acam_reg_t dol_1080p_30fps_2lane_12bits[] = {
    {0x3000, 0x01, 0xff, 1}, /* standby */
    {0xFFFF, 1},
    {0x3002, 0x00, 0xff, 1}, /* XTMSTA */
...
static acam_reg_t linear_1080p_60fps_892Mbps_2lane_10bits[] = {
    //{0x3003, 0x01, 0xff, 1}, /* sw_reset */
    //{0xFFFF, 200},
    {0x3000, 0x01, 0xff, 1}, /* standby */
    {0x3002, 0x00, 0xff, 1}, /* XTMSTA */
...
static const acam_reg_t *imx290_seq_table[] = {
    ...
    imx290_test_pattern,
    dol_1080p_30fps_2lane_12bits,
    dol_1080p_30fps_4lane_10bits,
    linear_1080p_30fps_222Mbps_4lane_12bits,
    linear_1080p_60fps_892Mbps_2lane_10bits,
};
