...
/**
 *   Setup firmware memory for scatter and gather dma feature from fw memory pairs of virtual address and length
 *
 *
...
/**
 *   Setup isp device memory for scatter and gather dma feature from pairs of dma bus address and length
 *
 *   @param ctx - pointer to dma channel data or NULL if error.
 *   @param buff_loc - points to ping or pong buffer.
 *   @param fwmem_pair - fw memory pairs of virtual address and length.
 *
 *   @return 0 - on success or -1 on error
 */
 ...
 *   @param ctx - pointer to dma channel data or NULL if error.
 *   @param buff_loc - points to ping or pong buffer.
 *   @param device_addr_pair - pairs of dma bus address and length.
 *
 *   @return 0 - on success or -1 on error
 */
