...
#define _READ_VDEC2_ST_REG(r) (read_dos_reg_comp(\
			(VDEC2_VLD_MEM_VIFIFO_START_PTR+(r))))
#define _WRITE_VDEC2_ST_REG(r, val) write_dos_reg_comp(\
