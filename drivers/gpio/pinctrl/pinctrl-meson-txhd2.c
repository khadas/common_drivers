...
static const struct pinctrl_pin_desc meson_txhd2_periphs_pins[] = {
	MESON_PIN(GPIODV_0),
	MESON_PIN(GPIODV_1),
	MESON_PIN(GPIODV_2),
	MESON_PIN(GPIODV_3),
...
static const struct pinctrl_pin_desc meson_txhd2_aobus_pins[] = {
	MESON_PIN(GPIOAO_0),
	MESON_PIN(GPIOAO_1),
	MESON_PIN(GPIOAO_2),
	MESON_PIN(GPIOAO_3),
...
static struct meson_pinctrl_data meson_txhd2_periphs_pinctrl_data __refdata = {
	...
	.num_pins	= ARRAY_SIZE(meson_txhd2_periphs_pins),
...
static const struct of_device_id meson_txhd2_pinctrl_dt_match[] = {
	{
		...
		.data = &meson_txhd2_periphs_pinctrl_data,
	},
	{
...
static struct platform_driver meson_txhd2_pinctrl_driver = {
...
#ifndef MODULE
static int __init txhd2_pmx_init(void)
{
	meson_txhd2_pinctrl_driver.driver.of_match_table =
			meson_txhd2_pinctrl_dt_match;
	return platform_driver_register(&meson_txhd2_pinctrl_driver);
}
arch_initcall(txhd2_pmx_init);

#else
int __init meson_txhd2_pinctrl_init(void)
{
	meson_txhd2_pinctrl_driver.driver.of_match_table =
			meson_txhd2_pinctrl_dt_match;
	return platform_driver_register(&meson_txhd2_pinctrl_driver);
}
module_init(meson_txhd2_pinctrl_init);
#endif
