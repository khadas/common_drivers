...
#define HDMITX20_VERSIONS_LOG \
	...
	"V03.01.02.00.02.05.20 [20230410] [COM] Adapt to low-resolution standard display\n" \
	"V03.01.02.00.02.05.21 [20230412] [NEW] Add more debug info of hdmitx\n" \
	"V03.01.02.00.02.05.22 [20230418] [COM] add unmute hdr work func\n" \
	"V03.01.02.00.02.05.23 [20230505] [COM] add hdr_priority_mode node hide or enable HDR\n" \
	"V03.01.02.00.02.05.24 [20230511] [COM] sync hdmi commit from project\n"
